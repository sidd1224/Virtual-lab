...
# Run migrations, change directory, and then start the server
CMD ["sh", "-c", "python vlab/manage.py migrate && cd vlab && gunicorn vlab.wsgi:application --bind 0.0.0.0:${PORT:-8080}"]
